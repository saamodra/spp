  ...
  <div class="col-md-12">
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        @endif
        <form action="{{ url('kas/kasmasuk') }}"" method="POST" role="form">
          {!! csrf_field() !!}
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  <span class="input-group-addon">Rp.</span>
                    <input type="text" class="form-control" placeholder="Pemasukan" name="pemasukan" id="pemasukan" value="{{ old('pemasukan') }}" onkeypress="isNumber(event)" required="">
